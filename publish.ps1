...
del exInstaller-*
cd "exInstaller/bin/Release/netcoreapp6.0/linux-arm/publish"
...
cd "../../../../../.."
echo 7z a ./exInstaller-linux-arm.tar -tgzip ./exInstaller-linux-arm.tar.gz
echo del exInstaller-linux-arm.tar
cd "exInstaller/bin/Release/netcoreapp6.0/linux-arm64/publish"
Remove-Item arduino-cli-runtimes/*_32bit -Recurse -Force -Confirm:$false
...
cd "../../../../../.."
echo 7z a ./exInstaller-linux-arm64.tar -tgzip ./exInstaller-linux-arm64.tar.gz
echo del exInstaller-linux-arm64.tar
cd "exInstaller/bin/Release/netcoreapp6.0/linux-x64/publish"
...
cd "../../../../../.."
echo 7z a ./exInstaller-linux-x64.tar -tgzip ./exInstaller-linux-x64.tar.gz
echo del exInstaller-linux-x64.tar
cd "exInstaller/bin/Release/netcoreapp6.0/win-x86/publish"
Remove-Item arduino-cli-runtimes/Linux* -Recurse -Force -Confirm:$false
Remove-Item arduino-cli-runtimes/mac* -Recurse -Force -Confirm:$false
Remove-Item arduino-cli-runtimes/*_64bit -Recurse -Force -Confirm:$false
7z a -tzip "../../../../../../exInstaller-win-x86.zip"
cd "../../../../../.."
cd "exInstaller/bin/Release/netcoreapp6.0/win-x64/publish"
Remove-Item arduino-cli-runtimes/Linux* -Recurse -Force -Confirm:$false
Remove-Item arduino-cli-runtimes/mac* -Recurse -Force -Confirm:$false
Remove-Item arduino-cli-runtimes/*_32bit -Recurse -Force -Confirm:$false
7z a -tzip "../../../../../../exInstaller-win-x64.zip"
cd "../../../../../.."
cd "exInstaller/bin/Release/netcoreapp6.0/osx-x64/publish"
Remove-Item arduino-cli-runtimes/Linux* -Recurse -Force -Confirm:$false
Remove-Item arduino-cli-runtimes/Win* -Recurse -Force -Confirm:$false
7z a -ttar "../../../../../../exInstaller-osx-x64.tar"
cd "../../../../../.."
echo 7z a ./exInstaller-osx-x64.tar -tgzip ./exInstaller-osx-x64.tar.gz
echo del exInstaller-osx-x64.tar
